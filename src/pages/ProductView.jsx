  ...
  return (
    <>
      <Layout bg="#fff">
        ...
        >
          <Box grid span="1 / -1" myStyle={{'@media (max-width: 900px)': {gtc: '1fr'}}}>
            <View className="flex center">
              ...
              {/* <div className="view_menu flex">
                <GiExpand onClick={() => setStateModal(true)} fontSize="2rem" />
              </div> */}
            </View>
            <Info>
      ...
      <Modal open={stateModal} z="11" onClick={() => setStateModal(false)}>
        <Box grid >
          <Slider
            width="700px"
            elements={elements}
